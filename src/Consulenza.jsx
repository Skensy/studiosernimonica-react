...
createRoot(document.getElementById("root")).render(
  <StrictMode>
    <Navbar />
    <Slider title="Consulenza Contrattuale del Lavoro" subtitle="consulente del lavoro" gradient="bg-gradient-to-r from-blue-800 to-indigo-900" />
    <Midcontent />
    <div className="mt-12 flex justify-around flex-wrap gap-4 mb-12">
      ...
      <Card Title="Consulenza Contrattuale e del Lavoro" Description="" imgUrl={Consulenza} Gradient="bg-gradient-to-r from-blue-800 to-indigo-900" Url="/consulenza-contrattuale-e-del-lavoro.html" />
